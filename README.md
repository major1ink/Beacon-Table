...
Дварфу факел не нужен: в меню токена есть тёмное зрение с собственным радиусом — в темноте он видит приглушённо, а его спутник-человек рядом не видит ничего.

У источника можно задать цвет и конус: тёплый факел, холодный фонарь строго вперёд, синее свечение портала.
...
![Карта пещеры с пометками: красная рамка и стрелка указывают на заметку, справа панель инструментов рисования](docs/assets/screenshots/scene-drawings.webp)
...
![Доска, перенесённая из Obsidian: сцены, стрелки, картинка и связанные с журналом врезки](docs/assets/screenshots/board-imported.webp)
