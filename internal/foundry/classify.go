...
// У сцен/плейлистов/заметок нет клиентского маппера и не может быть: сцена
// живёт в Room, плейлист и заметка — в своих сервисах, и все трое тянут за
// собой файлы из архива (карта, треки, картинки в тексте).
