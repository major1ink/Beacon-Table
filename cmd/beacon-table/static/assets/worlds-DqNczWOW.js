import{F as l,a7 as i,j as m,a8 as u,a9 as y,aa as g}from"./api-BC-wWyIL.js";const n=document.getElementById("list"),s=document.getElementById("createForm"),o=document.getElementById("createMsg"),f={"dnd5e-2024":"D&D 2024","dnd5e-2014":"D&D 5e (2014)"};function v(e){return f[e]||e}function d(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function h(e){const t=e.active?'<span class="pill-badge on">Активен</span>':"",a=e.active?`<button class="world-btn open-btn" data-id="${e.id}">Открыть стол →</button>`:`<button class="world-btn launch-btn" data-id="${e.id}">Запустить</button>`;return`
    <div class="row-card world-card" data-id="${e.id}">
      <div class="world-info">
        <div class="world-name">${d(e.name)}</div>
        <div class="world-meta">
          <span class="pill-badge">${v(e.system)}</span>
          ${t}
        </div>
      </div>
