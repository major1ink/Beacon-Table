import{i as z}from"./icons-D2tS5Ts8.js";let D=0;const K='a[href], button, input, select, textarea, [tabindex]:not([tabindex="-1"])';let A=!1;function L(){if(A)return;A=!0;const o=document.createElement("style");o.textContent=`
    .bt-modal-overlay {
