import{i as z}from"./icons-DsdpjbfO.js";let D=0;const K='a[href], button, input, select, textarea, [tabindex]:not([tabindex="-1"])';let A=!1;function L(){if(A)return;A=!0;const o=document.createElement("style");o.textContent=`
    .bt-modal-overlay {
