...
// desktop (см. desktop.go). Сам решает, поднимать ли стол и в какой папке
// (open — см. prepareIn), и возвращается, когда окно закрыли, а поднятый
// стол сохранил мир.
var runDesktop func(open func(dir string) (server, error))
