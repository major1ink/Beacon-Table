// heading-nav.js — «перейти к разделу»: кнопка-оглавление у длинной заметки/
// записи журнала. В Foundry сюжет приключения разбит на страницы с боковым
// списком; у нас все страницы слиты в один текст разделами «## …» (см.
// internal/foundry/journal.go), и без быстрого перехода по ним читать
// импортированный модуль неудобно.
//
// Общий модуль для журнала стола (pages/journal.js), окна заметки ДМ
// (pages/note-window.js) и боковой панели заметок (pages/dm.js) — поведение
// одинаковое. Всплывашка строится в JS с inline-стилями по CSS-переменным
// темы: так не нужно добавлять правила в три разных <style>.
