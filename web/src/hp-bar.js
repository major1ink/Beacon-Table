...
// абсолютное значение ТЕКУЩИХ хитов (0..max) под пальцем; сам жест не решает,
// дельта это или абсолют — это решает вызывающий в onCommit. Оба места
// (combat-panel.js, character-sheet.js) шлют его как дельту (value - current),
// чтобы урон, потянутый вниз, съедал временные хиты первым — так же, как
// ввод "-N" в поле рядом.
//
